package network 
{
	...
	public class NetworkManager 
	{
		...
		//private static var m_sServerIP:String = "192.168.0.100";
		//private static var m_sServerIP:String = "hyc.nzcstudy.top";
		//private static var m_sServerIP:String = "47.92.157.12";
		private static var m_sServerIP:String = "www.tianhgame.com";
		//private static var m_sServerIP:String = "localhost";
		//private static var m_sServerIP:String = "10.10.136.49";
		private static var m_sServerPort:String = "8001";
		...
		public function SocketConnect(userID:int):void
		{
			...
			var serverUrl:String = "wss://" + m_sServerIP +":" + m_sServerPort + "/game?id=" + userID;
			try{
		...
		private function HttpConnect(url:String,port:String,message:*,method:String,type:String,root:String):void
		{
			try
			{
				var serverUrl:String = "https://" + url +":" + port + "/"+root;
