package blls._Game 
{
	...
	public class GameSettlementLogic extends BaseLogic
	{
		...
		private function DealInfoList():void 
		{
			if (m_message.bao)
			{
				m_gameSettlementView.BaoPai.visible = true;
				m_gameSettlementView.BaoPai.pai = m_message.bao;
		...
		private function SetGamerBottomTotal(gamerInfo:*, gamer:Gamer):void 
		{
			...
			{
				m_totalScoreView.m_imgScore0.skin = "totalScore/img_achieve_0.png";
				m_totalScoreView.m_imgPlus0.skin = "totalScore/img_pr_0.png";
				m_totalScoreView.m_clipTen0.skin = "totalScore/clip_0.png";
				m_totalScoreView.m_clipBit0.skin = "totalScore/clip_0.png";
			...
			{
				m_totalScoreView.m_imgScore0.skin = "totalScore/img_achieve_1.png";
				m_totalScoreView.m_imgPlus0.skin = "totalScore/img_pr_1.png";
				m_totalScoreView.m_clipTen0.skin = "totalScore/clip_1.png";
				m_totalScoreView.m_clipBit0.skin = "totalScore/clip_1.png";
				m_totalScoreView.m_clipTen0.index = Math.floor(-gamerInfo.totalScore/10);
				m_totalScoreView.m_clipBit0.index = -gamerInfo.totalScore % 10;
		...
		private function SetGamerLeftTotal(gamerInfo:*, gamer:Gamer):void 
		{
			...
			if (gamerInfo.totalScore>=0)
			{
				m_totalScoreView.m_imgScore1.skin = "totalScore/img_achieve_0.png";
				m_totalScoreView.m_imgPlus1.skin = "totalScore/img_pr_0.png";
				m_totalScoreView.m_clipTen1.skin = "totalScore/clip_0.png";
				m_totalScoreView.m_clipBit1.skin = "totalScore/clip_0.png";
			...
			{
				m_totalScoreView.m_imgScore1.skin = "totalScore/img_achieve_1.png";
				m_totalScoreView.m_imgPlus1.skin = "totalScore/img_pr_1.png";
				m_totalScoreView.m_clipTen1.skin = "totalScore/clip_1.png";
				m_totalScoreView.m_clipBit1.skin = "totalScore/clip_1.png";
				m_totalScoreView.m_clipTen1.index = Math.floor(-gamerInfo.totalScore/10);
				m_totalScoreView.m_clipBit1.index = -gamerInfo.totalScore % 10;
		...
		private function SetGamerTopTotal(gamerInfo:*, gamer:Gamer):void 
		{
			...
			if (gamerInfo.totalScore>=0)
			{
				m_totalScoreView.m_imgScore2.skin = "totalScore/img_achieve_0.png";
				m_totalScoreView.m_imgPlus2.skin = "totalScore/img_pr_0.png";
				m_totalScoreView.m_clipTen2.skin = "totalScore/clip_0.png";
				m_totalScoreView.m_clipBit2.skin = "totalScore/clip_0.png";
			...
			{
				m_totalScoreView.m_imgScore2.skin = "totalScore/img_achieve_1.png";
				m_totalScoreView.m_imgPlus2.skin = "totalScore/img_pr_1.png";
				m_totalScoreView.m_clipTen2.skin = "totalScore/clip_1.png";
				m_totalScoreView.m_clipBit2.skin = "totalScore/clip_1.png";
				m_totalScoreView.m_clipTen2.index = Math.floor(-gamerInfo.totalScore/10);
				m_totalScoreView.m_clipBit2.index = -gamerInfo.totalScore % 10;
		...
		private function SetGamerRightTotal(gamerInfo:*, gamer:Gamer):void 
		{
			...
			if (gamerInfo.totalScore>=0)
			{
				m_totalScoreView.m_imgScore3.skin = "totalScore/img_achieve_0.png";
				m_totalScoreView.m_imgPlus3.skin = "totalScore/img_pr_0.png";
				m_totalScoreView.m_clipTen3.skin = "totalScore/clip_0.png";
				m_totalScoreView.m_clipBit3.skin = "totalScore/clip_0.png";
			...
			{
				m_totalScoreView.m_imgScore3.skin = "totalScore/img_achieve_1.png";
				m_totalScoreView.m_imgPlus3.skin = "totalScore/img_pr_1.png";
				m_totalScoreView.m_clipTen3.skin = "totalScore/clip_1.png";
				m_totalScoreView.m_clipBit3.skin = "totalScore/clip_1.png";
				m_totalScoreView.m_clipTen3.index = Math.floor(-gamerInfo.totalScore/10);
				m_totalScoreView.m_clipBit3.index = -gamerInfo.totalScore % 10;
